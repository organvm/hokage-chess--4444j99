...
- **Email Curator ("The Scroll").** Configures Kit (ConvertKit) free tier; drafts the 3-email welcome sequence (who-I-am / embarrassing-loss / Village invite); ships once lead magnet lands; maintains the Hokage chess track inside the MP-7 shared subscriber base
...
- `../../business/2026-06-21-email-list-architecture-decision.md` — MP-7 list model the Email Curator must preserve
