...
| V-B | [#48](https://github.com/4444J99/hokage-chess/issues/48) | P2 | Phase 3 canonical-home promotion + seed.yaml schema normalization — ✓ canonical target present at `meta-organvm/governance/client-separation-substrate.md`; this repo now keeps a forwarding stub and top-level `seed.yaml: client` |
...
- V-B → [#48](https://github.com/4444J99/hokage-chess/issues/48) — Phase 3 substrate-doc canonical-home promotion + seed.yaml schema normalization · ✓ canonical target present at `meta-organvm/governance/client-separation-substrate.md`; Hokage repo now keeps a forwarding stub and top-level `seed.yaml: client`
